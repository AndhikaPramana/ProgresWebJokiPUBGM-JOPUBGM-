...
$query_harga_joki= mysqli_query($koneksi, "SELECT * FROM tbl_jenis_joki LIMIT 4");
?>
<div class="col-sm-4">
	...
	<div class="list-group">
		<span class="list-group-item text-white mt-3" style="background-color: #ED8240">Jenis dan Harga Joki</span>
		<?php while($harga_joki = mysqli_fetch_assoc($query_harga_joki)) : ?>
			<a href="jenis_joki.php?id=<?= $harga_joki['id'] ?>" class="list-group-item list-group-item-action"><?= $harga_joki['jenis_joki'] ?></a>
		<?php endwhile; ?>
	</div>
</div>