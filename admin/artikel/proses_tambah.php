...
if($_FILES['foto']['error'] == 0){
	...
	//validasi foto
	if($nama_foto!="image/gif" && $nama_foto!="image/jpg" && $nama_foto!="image/jpeg" && $nama_foto!="image/png"){
		echo $nama_foto."<br/>";
		header('Location: index.php');
	}else{
		$_SESSION['gagal'] = 'tidak di support, hanya untuk upload gambar (gif, jpg,jpef,png)';
		header('Location: index.php');
	}
}